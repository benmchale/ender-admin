...
token = 'NzAzMzIwNzg4NzQ0NTM2MDg1.XqM8Ag.h8Cx6sifNTWvsuPiTxfSakYLlEE'
...
async def on_member_join(member):
    channel = client.get_channel(id=703708705941749790)
    ...
    channel = client.get_channel(id=701520392056995870)
...
async def mute(ctx, member: discord.Member, amount=1, reason=None):
    ...
    channel_log_id = 703944983253614662
